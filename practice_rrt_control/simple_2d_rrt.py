""" RRT* for robot control """

"""
Action-space RRT
1) Free space: generate 6-dimension action space
    - 6d path point
    - goal position: multiple points possible (infinite)
    - goal pose -> init pose, goal pose, obstacles -> RRT possible
2) Constraint: map obstacles to rrt action space
"""
"""
Cartesian-space RRT
1) 3D cartesian space RRT
2) follow path points with IK
"""
